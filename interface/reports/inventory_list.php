...
require_once("$include_root/drugs/inventory_acl.inc.php");
 ...
 <tr>
  ...
  <td class='text' align='right'>
   ...
   /><?php echo xlt('Include Inactive'); ?>&nbsp;
    ...
    $tmparr = [0 => xl('Summary'), 1 => xl('Facility Details'), 2 => xl('Warehouse Details')];
...
if ($form_action) { // if submit
    ...
    $last_drug_id = '';
    $wrl_last_drug_id = '';
    $warehouse_row = ['drug_id' => 0, 'warehouse_id' => ''];
