...
class PatientRelationshipServiceTest extends TestCase
{
    ...
    private function removeRelationshipFixtures(): void
    {
        ...
        sqlStatement("DELETE FROM patient_relationships WHERE notes LIKE 'TEST:%'");
    }
    ...
    public function testCreateRelationshipWithInvalidPatient()
    {
        $relationship = new PatientRelationship(
    ...
    public function testCreateRelationshipWithInvalidData()
    {
        $relationship = new PatientRelationship(
            1,
            1, // Same patient ID
    ...
    public function testGetPatientRelationships()
    {
    ...
    public function testBidirectionalRelationshipQuery()
    {
