...
class PatientRelationshipTest extends TestCase
{
    ...
    public function testValidateReturnsNoErrorsForValidData()
    {
    ...
    public function testValidateReturnsErrorsForInvalidPatientId()
    {
    ...
    public function testValidateReturnsErrorsForInvalidRelatedPatientId()
    {
    ...
    public function testValidateReturnsErrorsForSamePatientIds()
    {
        $relationship = new PatientRelationship(1, 1, 'lives_with', 3);
        $errors = $relationship->validate();
    ...
    public function testValidateReturnsErrorsForEmptyRelationshipType()
    {
    ...
    public function testValidateReturnsErrorsForInvalidCreatedBy()
    {
